...
import { FolderIcon, DocumentTextIcon, CalendarIcon, ClockIcon } from '@heroicons/react/24/outline';
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center py-12">
          <h1 className="text-2xl font-bold mb-4 text-red-600 dark:text-red-400">加载失败</h1>
...
const CategoryPosts: React.FC<CategoryPostsProps> = ({ categoryName }) => {
  const { posts, category, loading, error, totalPosts } = useCategoryPosts(categoryName);
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <nav className="mb-6">
        <ol className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          <li>/</li>
          <li>
            <Link to="/category" className="hover:text-blue-600 dark:hover:text-blue-400">
              分类
            </Link>
          </li>
          <li>/</li>
