  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-24 md:py-32">
      ...
      <header className="mb-24">
        ...
        >
          <div className="flex items-center gap-3 mb-6 text-accent font-mono text-xs tracking-widest">
            ...
            >
              <Link to={`/post/${post.slug}`} className="block">
                ...
                <div className="flex items-center gap-2 text-zinc-100 font-mono text-sm">
                  阅读全文 <ArrowUpRight size={16} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                </div>
              </Link>
            </motion.article>
          ))}
      ...
      {/* 页脚 */}
      <footer className="mt-32 pt-12 border-t border-zinc-900 text-zinc-600 font-mono text-[10px] uppercase tracking-widest flex flex-col md:flex-row justify-between gap-4">
        <div>© 2026 BINBIM. 为极致性能而设计。</div>
        <div className="hidden md:block">籍贯：广西贵港 / 求学：广西柳州 / 24°19′N 109°24′E</div>
      </footer>
    </main>
  );
}
